...
def main(args):
    ...
    for iter in range(args.i):
        ...
        training_args = TrainingArguments("quora_model_%s_%s_%s" % (args.n, args.m, iter), logging_strategy="epoch", evaluation_strategy="epoch", save_strategy="epoch", num_train_epochs=args.epochs, save_total_limit=2, load_best_model_at_end=True, metric_for_best_model="eval_accuracy")
